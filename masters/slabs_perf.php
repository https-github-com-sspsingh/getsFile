<?PHP
    ...
    $headTitle	=	'Slabs - Performance';
    $titleText	=	$action ==	'view'	?	'All Slabs - Performance List' : (!empty($id) ? 'Edit Slabs' : 'Add New Slabs' );
...
if(($("#fieldsID").val() == 1))
{
	...
	frmvalidator.addValidation("frmID","req","Enter From Slab ");
	frmvalidator.addValidation("toID","req","Enter To Slab ");
	frmvalidator.addValidation("pun_penalty","req","Enter Punctuality Penalty ");
	frmvalidator.addValidation("saf_penalty","req","Enter Safety Score Penalty ");
