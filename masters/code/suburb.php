...
class Masters extends SFunctions
{
	...
	public function view()
	{
		if($this->permissions['viewID'] == 1 || $_SESSION[$this->website]['userTY'] == 'AD')
		{
			...
			if($Qry->execute())
			{
				...
				{ 
					...
					if($this->permissions['editID'] == 1 || $_SESSION[$this->website]['userTY'] == 'AD')
					{
						...
						{
							echo '<td align="center"><a class="fa fa fa-users POPUP_uslogsID" aria-sort="'.($this->frmID.'_'.$row['ID'].'_Suburbs Master').'" style="text-decoration:none; cursor:pointer;"></a></td>';
						}
						else	{echo '<td></td>';}
					}
            ...
            {
                echo '<div class="row"><div class="col-xs-12" style="min-height:200px;margin-top:150px; text-align:center">Sorry....you haven\'t permission\'s to view <b>Suburbs Master</b> Page</div></div>';
            }
	} 
	...
	echo '<div class="row">';  
		echo '<div class="col-xs-5">';
			...
			echo '<input type="text" onchange="changes=true;" class="form-control" id="title" name="title" placeholder="Enter Suburb Name"
	...
	echo '<div class="row">';
		echo '<div class="col-xs-2">';
			...
			echo '<input type="text" onchange="changes=true;" class="form-control decimal_places_1 numeric positive" maxlength="4" id="pincode" name="pscode" placeholder="Enter PostCode" maxlength="4" 
		...
		echo '<div class="col-xs-3">';
			...
			echo '<input type="text" onchange="changes=true;" class="form-control" id="plstationID" name="plstationID" placeholder="Enter Police StationID"
	...
	echo '<div class="row">';
	  ...
	  if(!empty($id))
		  ...
		  echo '<button onchange="changes=false;" class="btn btn-primary btn-flat" name="Submit" type="submit">'.(!empty($id) ? 'Update Suburbs Master' : 'Save Suburbs Master').'</button>';
	  echo '</div>';
	echo '</div>';
	echo '</div>';
	echo '</form>';
