<?PHP
	...
	$headTitle  = 'Employee - TransferedOut';
	$titleText  = $action == 'view' ? 'All Employee - TransferedOut List' : (!empty($id) ? 'Edit Employee - TransferedOut' : 'Add New Employee - TransferedOut' );
?>
...
if(($("#fieldsID").val() == 1))
{
	...
	frmvalidator.addValidation("o_codeID","num","Plz select Employee Name / Employee Code");
    frmvalidator.addValidation("o_codeID","gt=0","Plz select Employee Name / Employee Code "); 
	
	frmvalidator.addValidation("n_codeID","req","Enter New Code ");
	
	frmvalidator.addValidation("transferID","num","Plz select Transfer To Depot");
    frmvalidator.addValidation("transferID","gt=0","Plz select Transfer To Depot ");
