<?PHP
    ...
    $headTitle	=   'Hazard Register';
    $titleText	=   $action ==	'view'	? 'All Hazard Register List' : (!empty($id) ? 'Edit Hazard' : 'Add New Hazard' );
	
	/* SET - CRITERIA */
	$passSTR = "";
	$passSTR = ($dashID == 1 ? " " 
			  :($dashID == 2 ? " AND Date_Add(hiz_regis.rdateID, INTERVAL 28 DAY) < '".date("Y-m-d")."' " : ""));
...
<div class="row" style=" padding-left:10px !important;">
    ...
    <div class="col-md-1" style="margin-left:30px;">
        ...
        <a class="btn btn-primary btn-flat btn-flat fa fa-download" href="<?=$login->home.'downloadCSV.php?s=HIZ_REGISTER&fdateID='.$fdateID.'&tdateID='.$tdateID.'&searchbyID='.$searchbyID.'&dashID='.$dashID.'&auditID='.$auditID?>"> Export Excel</a>
    </div>
...
$(($("#fieldsID").val() == 1 ? "#HIZrefno" : "#searchbyID")).focus();
