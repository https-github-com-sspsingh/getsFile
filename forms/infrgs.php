<?PHP
    ...
    $headTitle	=	'Infringement Details';
    $titleText	=	$action ==	'view'	?	'All Infringement Details List' : (!empty($id) ? 'Edit Infringement Details' : 'Add New Infringement Details' );
	
	/* SET - CRITERIA */
	$passSTR = "";
	$passSTR = $dashID == 2 ? " AND Date_Add(dateID_3, INTERVAL 7 DAY) <= '".date("Y-m-d")."' " : "";
?>
...
<div class="row" style=" padding-left:10px !important;">
    ...
    <div class="col-md-1" style="margin-left:30px;"> 
		<a class="btn btn-primary btn-flat btn-flat fa fa-download" href="<?=$login->home.'downloadCSV.php?s=INFRINGMENT_REGISTER&fdateID='.$fdateID.'&tdateID='.$tdateID.'&searchbyID='.$searchbyID.'&dashID='.$dashID.'&auditID='.$auditID?>"> Export Excel</a>
    </div>
</div>
</form>
<?PHP
...
$(($("#fieldsID").val() == 1 ? "#infrefno" : "#searchbyID")).focus();
