<?PHP
    ...
    $headTitle	=   'Inspection Register';
    $titleText	=   ($action ==	'view'	?	'All Inspection Register List' : (!empty($id) ? 'Edit Inspection Register' : 'Add New Inspection Register' ));
...
<a class="btn btn-primary btn-flat btn-flat fa fa-download" href="<?=$login->home.'downloadCSV.php?s=INSPECTION_REGISTER&fdateID='.$fdateID.'&tdateID='.$tdateID.'&searchbyID='.$searchbyID.'&dashID='.$dashID.'&auditID='.$auditID?>"> Export Excel</a>
    </div>
</div>
</form>
<?PHP
...
$(($("#fieldsID").val() == 1 ? "#rptno" : "#searchbyID")).focus();
