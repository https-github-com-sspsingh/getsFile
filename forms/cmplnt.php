<?PHP
    ...
    $headTitle	=   'Customer Feedback Register';
    $titleText	=   $action ==	'view'	?	'All Customer Feedback Register List' : (!empty($id) ? 'Edit Customer Feedback' : 'Add New Customer Feedback' );
...
<div class="row" style=" padding-left:10px !important;">
    ...
    <div class="col-md-1" style="margin-left:30px;">
		<a class="btn btn-primary btn-flat btn-flat fa fa-download" href="<?=$login->home.'downloadCSV.php?s=COMMENTLINE_REGISTER&fdateID='.$fdateID.'&tdateID='.$tdateID.'&searchbyID='.$searchbyID.'&dashID='.$dashID.'&auditID='.$auditID?>"> Export Excel</a>
    </div>
...
$(($("#fieldsID").val() == 1 ? "#cmprefno" : "#searchbyID")).focus(); 
