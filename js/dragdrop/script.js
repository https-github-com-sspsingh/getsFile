...
// redips initialization
 redipsInit = function ()
 {
	...
	rd.event.dropped = function () 
	{
		...
		document.getElementById('SwappingStartEndTime').value = 2;
		document.getElementById('getinfoID').removeAttribute("disabled");
		swappingPage();
	};
...
{
	if(document.getElementById('SwappingStartEndTime').value == 2 && document.getElementById('SwappingRunningsTime').value == 0)
	{
		document.getElementById('SwappingRunningsTime').value = 1;
		var srsID = 0;
		for(srsID = 0; srsID <= 5000;  srsID++)
		{
			$("#getinfoID").fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100);
		}
	}
}
