<?PHP
	...
	$headTitle	=	'Form-Set Master';
	$titleText	=	$action ==	'view'	?	'All Form-Set Master List' : (!empty($id) ? 'Edit Form-Set' : 'Add New Form-Set' );
...
if(($("#fieldsID").val() == 1))
{
	...
	frmvalidator.addValidation("ftypeID","num","Plz select Form Type");
    frmvalidator.addValidation("ftypeID","gt=0","Plz select Form Type ");

	frmvalidator.addValidation("code","req","Enter Form Code ");
	frmvalidator.addValidation("title","req","Enter Form Name "); 
}
</script>
