<?PHP
	...
	$headTitle	= 'User Master';
	$titleText	= ($action ==	'view'	? 'All User Master List' : (!empty($id) ? 'Edit User' : 'Add New User'));
?>
...
if(($("#fieldsID").val() == 1))
{
	...
	frmvalidator.addValidation("usernameID","req","Enter User Name ");
}
</script>