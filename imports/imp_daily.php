...
<!-- Right side column. Contains the navbar and content of the page -->
    ...
    ?>
            ...
            <div style="display:inline-block;">
                ...
                <option value="0" selected="selected" disabled="disabled">-- Signon Required For --</option>
                <option value="1">First & Second Half</option>
                <option value="2">First Half Only</option>
                </select>
            </div>
            ...
            ?>
                ...
                <div style="display:inline-block;">
                    <input type="datable" class="form-control datepicker" data-datable="ddmmyyyy" name="dateID" id="dateID" value="<?=$_REQUEST['dateID']?>" placeholder="Enter Shift Date" style="text-align:center;" />
                </div>            
            ...
            {
				?>
				<div class="btn bg-olive btn-flat btn-file" id="imp_partID" style="margin-top: 10px;">
            ...
            ?>            
            <button class="btn bg-navy btn-flat" name="Submit" id="imp_partID_1" style="margin-top: 9px;" type="submit">Submit</button>
            <button class="btn bg-maroon btn-flat delete_import_log" id="del_partID" style="display:none; margin-top: 9px;" type="button">Delete Import Sheet</button>
            
            <a href="<?=$basename?>?cs=<?=$Imports->Encrypt($caseID)?>" id="imp_partID_2" style="margin-top: 9px;" class="btn bg-navy btn-flat">Clear Filters</a>
            ...
            {
                ?>
                        <a data-title="imp_shifts" data-rel="80" data-ajax="<?=$_POST['fdateID']?>" class="btn bg-maroon btn-flat Delete_Confirm">Delete Log 
            ...
            {
                ?>
                        <a class="btn bg-maroon btn-flat" style="margin-top: 9px;" href="<?=$login->home.'exportCSV.php?s=DAILY_SHEET&fromID='.$_POST['dateID']?>">Download Excel</a>	
                <?PHP
            }
            ...
            {
                ?>
                        <a class="btn bg-maroon btn-flat" style="margin-top: 9px;" href="<?=$login->home.'exportCSV.php?s=DAILY_SHEET_GENERATOR&fromID='.$_POST['dateID']?>">Download Import Format</a>	
                <?PHP
            }
