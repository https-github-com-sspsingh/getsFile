<?PHP
    ...
    include '../header.php';
    include '../sidebar.php';
    include 'code/rpt_prior_alloc.php';
    $reports = new Reports();
    
    $basename  = basename($_SERVER['PHP_SELF']);	
    $headTitle = 'Prior Allocation Sheet';
...
function PrintPage(elem)
{
    ...
    function Popup(data) 
    {
        ...
        mywindow.document.write('<html><head><title>Prior Allocation Sheet (Date : <?=$fromID?>)</title>');
        mywindow.document.write('</head>');
        mywindow.document.write('<body><tr><th colspan="13" style="border:none 0px;"><b>Prior Allocation Sheet (Date : <?=$fromID?>)</b></th></tr></br></br>');
